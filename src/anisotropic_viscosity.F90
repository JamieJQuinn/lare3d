...
#ifdef PARALLEL_SWITCHING_FUNCTION
...
#ifdef ISOTROPIC_SWITCHING_FUNCTION
    ! 1 - \eta_1
    xi2 = 4.0_num*xi2 ! this is to correct for eta_1 depending on 2*xi
    calc_switching2 = 1.0_num - (6._num/5._num*xi2 + 2.23_num)/(2.23_num + 4.03_num*xi2 + xi2**2)
#endif

#ifdef VON_MISES_SWITCHING_FUNCTION
